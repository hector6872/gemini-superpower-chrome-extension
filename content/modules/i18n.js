...
(function () {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      field_cmd_name: 'Shortcut Name (single word, e.g. fix, test)',
    ...
    es: {
      ...
      field_cmd_name: 'Nombre del atajo (palabra única, ej. fix, test)',
      ...
      btn_save_command: 'Guardar prompt',
      btn_edit: 'Editar',
      btn_delete: 'Eliminar',
    ...
    de: {
      ...
      field_cmd_name: 'Prompt-Kürzel (ein Wort, z. B. fix, test)',
      ...
      btn_save_command: 'Prompt speichern',
      btn_edit: 'Bearbeiten',
      btn_delete: 'Löschen',
    ...
    fr: {
      ...
      field_cmd_name: 'Raccourci du prompt (un mot, ex. fix, test)',
      ...
      btn_save_command: 'Enregistrer le prompt',
      btn_edit: 'Modifier',
    ...
    it: {
      ...
      field_cmd_name: 'Nome comando (singola parola, es. fix, test)',
    ...
    pt: {
      ...
      field_cmd_name: 'Nome do atalho (uma palavra, ex: fix, test)',
      ...
      btn_save_command: 'Salvar prompt',
      btn_edit: 'Editar',
      btn_delete: 'Excluir',
      btn_export: 'Exportar JSON',
      btn_import: 'Importar JSON',
    ...
    ja: {
      ...
      field_cmd_name: 'ショートカット名（1単語、例: fix, test）',
