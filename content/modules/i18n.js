...
(function () {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      field_cmd_name: 'Shortcut name (single word)',
      field_short_desc: 'Description (optional)',
      field_auto_model: 'Change model automatically',
      field_prompt_text: 'Prompt content',
      placeholder_cmd_name: 'e.g. review',
      placeholder_desc: 'e.g. Polish tone and improve readability',
      placeholder_template: 'e.g.\nAct as an expert editor. Please rewrite and refine the following text according to these guidelines:\n• Improve clarity, flow, and precision\n• Maintain an engaging, professional tone\n• Provide a brief summary of the key changes made',
    ...
    es: {
      ...
      field_cmd_name: 'Nombre del atajo (una sola palabra)',
      ...
      placeholder_cmd_name: 'ej. resumen',
      placeholder_desc: 'ej. Pulir el tono y mejorar la claridad',
      placeholder_template: 'ej.\nActúa como un editor experto. Por favor, reescribe y optimiza el siguiente texto siguiendo estas pautas:\n• Mejora la claridad, fluidez y coherencia\n• Mantén un tono cercano pero profesional\n• Añade al final un breve resumen de los cambios realizados',
    ...
    de: {
      ...
      field_cmd_name: 'Kürzel-Name (einzelnes Wort)',
      field_short_desc: 'Beschreibung (optional)',
      field_auto_model: 'Modell automatisch wechseln',
      field_prompt_text: 'Prompt-Inhalt',
      placeholder_cmd_name: 'z. B. notiz',
      placeholder_desc: 'z. B. Tonfall verfeinern und Lesbarkeit verbessern',
      placeholder_template: 'z. B.\nAgieren Sie als erfahrener Lektor. Bitte überarbeiten Sie den folgenden Text nach diesen Richtlinien:\n• Verbessern Sie Klarheit, Fluss und Präzision\n• Sorgen Sie für einen ansprechenden, professionellen Ton\n• Fügen Sie am Ende eine kurze Übersicht der wichtigsten Änderungen an',
    ...
    fr: {
      ...
      field_cmd_name: 'Nom du raccourci (un seul mot)',
      ...
      placeholder_cmd_name: 'ex. note',
      placeholder_desc: 'ex. Améliorer la clarté et le style',
      placeholder_template: 'ex.\nAgissez en tant que rédacteur expert. Veuillez réécrire et perfectionner le texte suivant selon ces consignes :\n• Améliorez la clarté, la fluidité et la précision\n• Adoptez un ton professionnel et captivant\n• Ajoutez un bref récapitulatif des modifications apportées',
    ...
    it: {
      ...
      field_cmd_name: 'Nome della scorciatoia (parola singola)',
      ...
      placeholder_cmd_name: 'es. bozza',
      placeholder_desc: 'es. Migliora la chiarezza e lo stile',
      placeholder_template: 'es.\nAgisci come un editor esperto. Per favore riscrivi e ottimizza il testo seguente seguendo queste linee guida:\n• Migliora chiarezza, scorrevolezza e precisione\n• Mantieni un tono professionale e coinvolgente\n• Aggiungi alla fine un breve riepilogo delle modifiche principali',
    ...
    pt: {
      ...
      field_cmd_name: 'Nome do atalho (palavra única)',
      field_short_desc: 'Descrição (opcional)',
      field_auto_model: 'Trocar modelo automaticamente',
      field_prompt_text: 'Conteúdo do prompt',
      placeholder_cmd_name: 'ex: resumo',
      placeholder_desc: 'ex: Polir o tom e melhorar a clareza',
      placeholder_template: 'ex:\nAtue como um editor especialista. Por favor, reescreva e aprimore o seguinte texto de acordo com estas diretrizes:\n• Melhore a clareza, fluidez e precisão\n• Mantenha um tom profissional e cativante\n• Adicione ao final um breve resumo das alterações realizadas',
    ...
    ja: {
      ...
      field_cmd_name: 'ショートカット名（1単語のみ）',
      field_short_desc: '説明（任意）',
      field_auto_model: 'モデルを自動で切り替える',
      field_prompt_text: 'プロンプトの内容',
      placeholder_cmd_name: '例: memo',
      placeholder_desc: '例: 文章のトーンを整え、読みやすさを向上',
      placeholder_template: '例:\nプロの編集者として振る舞ってください。以下のガイドラインに従って、次の文章を推敲・改善してください：\n• 明確さ、読みやすさ、正確さを向上させる\n• プロフェッショナルで魅力的なトーンを維持する\n• 最後に主な改善点を箇条書きで簡潔にまとめる',
