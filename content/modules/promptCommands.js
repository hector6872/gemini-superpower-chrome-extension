          ...
          <div class="gsp-editor-fields-row">
            <div class="gsp-input-group gsp-group-cmd-name">
              ...
              <div class="gsp-cmd-input-container">
                ...
                <input type="text" id="gsp-form-title" class="gsp-input-field gsp-cmd-input" required placeholder="${t('placeholder_cmd_name')}" value="${escapeHtml(targetPrompt.title)}" autocomplete="off" spellcheck="false" autofocus>
              </div>
            </div>

            <div class="gsp-input-group gsp-group-cmd-desc">
              <label class="gsp-input-label" for="gsp-form-desc">${t('field_short_desc')}</label>
              <input type="text" id="gsp-form-desc" class="gsp-input-field" placeholder="${t('placeholder_desc')}" value="${escapeHtml(targetPrompt.desc)}" autocomplete="off" spellcheck="true">
            </div>
          </div>
